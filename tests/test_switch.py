...
class TestProfileOptimizedSwitchFactory:
    ...
    def test_module_configs_definition(self):
        ...
        for module_id, module_name, icon in ProfileOptimizedSwitchFactory.MODULE_CONFIGS:
...
class TestAsyncSetupEntry:
    ...
    async def test_async_setup_entry_profile_optimization(
        ...
        with patch("custom_components.pawcontrol.switch._async_add_entities_in_batches") as mock_batch:
            mock_batch.side_effect = lambda async_add_func, entities: async_add_func(entities, False)
...
class TestSpecificSwitchClasses:
    ...
    @pytest.mark.asyncio
    async def test_main_power_switch_set_state(
        ...
        data_manager.async_set_dog_power_state.assert_called_once_with("test_dog", False)
    ...
    @pytest.mark.asyncio
    async def test_do_not_disturb_switch_set_state(
        self, mock_coordinator, mock_hass
    ):
        ...
        notification_manager.async_set_dnd_mode.assert_called_once_with("test_dog", True)
    ...
    @pytest.mark.asyncio
    async def test_visitor_mode_switch_set_state(
        self, mock_coordinator, mock_hass
    ):
    ...
    @pytest.mark.asyncio
    async def test_feature_switch_set_gps_tracking(
        self, mock_coordinator, mock_hass
    ):
    ...
    @pytest.mark.asyncio
    async def test_feature_switch_set_notifications(
        self, mock_coordinator, mock_hass
    ):
    ...
    @pytest.mark.asyncio
    async def test_feature_switch_unknown_feature(
        self, mock_coordinator, mock_hass
    ):
...
class TestSwitchErrorHandling:
    ...
    async def test_feature_switch_error_handling(self, mock_coordinator):
        ...
        data_manager.async_set_gps_tracking = AsyncMock(side_effect=Exception("Test error"))
