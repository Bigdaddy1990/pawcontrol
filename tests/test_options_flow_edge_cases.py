...
class TestEntityProfileManagement:
    ...
    async def test_entity_profiles_step_error_handling(self, options_flow):
        ...
        with patch.object(options_flow, 'async_create_entry', side_effect=Exception("Test error")):
            result = await options_flow.async_step_entity_profiles({
                "entity_profile": "standard"
            })
    ...
    def test_profile_description_placeholders(self, options_flow):
        ...
        required_keys = [
            "current_profile", "current_description", "dogs_count",
            "estimated_entities", "max_entities_per_dog", "performance_impact"
        ]
    ...
    def test_performance_impact_description_unknown_profile(self, options_flow):
        ...
        description = options_flow._get_performance_impact_description("unknown_profile")
...
class TestPerformanceSettings:
    ...
    def test_performance_settings_schema_defaults(self, options_flow):
        ...
        expected_fields = [
            "entity_profile", "performance_mode", "batch_size", 
            "cache_ttl", "selective_refresh"
        ]
...
class TestDogManagementOperations:
    ...
    async def test_add_new_dog_error_handling(self, options_flow):
        ...
        options_flow.hass.config_entries.async_update_entry.side_effect = Exception("Update failed")
...
class TestSettingsCategories:
    ...
    async def test_gps_settings_error_handling(self, options_flow):
        ...
        with patch.object(options_flow, 'async_create_entry', side_effect=Exception("Test error")):
            result = await options_flow.async_step_gps_settings({
                "gps_enabled": True
            })
    ...
    async def test_advanced_settings_valid_update(self, options_flow):
        ...
        with patch.object(options_flow, '_async_save_options') as mock_save:
            mock_save.return_value = AsyncMock(return_value={
...
class TestNavigationAndStateManagement:
    ...
    async def test_init_menu_display(self, options_flow):
        ...
        expected_options = [
            "entity_profiles", "manage_dogs", "performance_settings",
            "gps_settings", "notifications", "feeding_settings",
            "health_settings", "system_settings", "dashboard_settings",
            "advanced_settings", "import_export"
        ]
    ...
    def test_dogs_list_copy_independence(self, options_flow):
        ...
        if options_flow._dogs:
            ...
            assert options_flow._config_entry.data[CONF_DOGS][0][CONF_DOG_NAME] == original_name
    ...
    async def test_save_options_error_handling(self, options_flow):
        ...
        with patch.object(options_flow, 'async_create_entry', side_effect=Exception("Save failed")):
            result = await options_flow._async_save_options()
    ...
    def test_memory_usage_with_deep_copying(self, options_flow):
        ...
        for i in range(10):
            dog = {
                ...
                "nested_data": {
                    f"level_{j}": {
                        f"sublevel_{k}": f"data_{i}_{j}_{k}"
                        for k in range(10)
                    }
                    for j in range(10)
                }
...
class TestEntityFactoryIntegration:
    ...
    def test_entity_estimation_edge_cases(self, options_flow):
        ...
        edge_cases = [
            ...
            {MODULE_FEEDING: True, MODULE_GPS: True, MODULE_HEALTH: True, MODULE_WALK: True},  # All enabled
        ]
