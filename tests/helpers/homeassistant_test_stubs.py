...
class _FlowManager:
    ...
    async def async_init(
        ...
        *,
        ...
        if handler_cls is None:
            raise ValueError(
                f"No config flow handler registered for domain '{domain}'")
        ...
        *,
        ...
        details = {
            **existing,
            ...
            "learn_more_url": (
                learn_more_url if learn_more_url is not None else existing.get(
                    "learn_more_url")
            ),
            "is_persistent": (
                is_persistent
    ...
    def _load_submodule(name: str):
        ...
        try:
            ...
            init_module = importlib.import_module(
                "custom_components.pawcontrol.__init__")
...
def install_homeassistant_stubs() -> None:
    ...
    restore_state_module = types.ModuleType(
        "homeassistant.helpers.restore_state")
    ...
    service_info_module = types.ModuleType(
        "homeassistant.helpers.service_info")
    ...
    zeroconf_module = types.ModuleType(
        "homeassistant.helpers.service_info.zeroconf")
    ...
    button_component_module = types.ModuleType(
        "homeassistant.components.button")
    date_component_module = types.ModuleType("homeassistant.components.date")
    datetime_component_module = types.ModuleType(
        "homeassistant.components.datetime")
    ...
    number_component_module = types.ModuleType(
        "homeassistant.components.number")
    script_component_module = types.ModuleType(
        "homeassistant.components.script")
    script_config_module = types.ModuleType(
        "homeassistant.components.script.config")
    script_const_module = types.ModuleType(
        "homeassistant.components.script.const")
    select_component_module = types.ModuleType(
        "homeassistant.components.select")
    sensor_component_module = types.ModuleType(
        "homeassistant.components.sensor")
    switch_component_module = types.ModuleType(
        "homeassistant.components.switch")
    system_health_component_module = types.ModuleType(
        "homeassistant.components.system_health",
    )
    text_component_module = types.ModuleType("homeassistant.components.text")
    weather_component_module = types.ModuleType(
        "homeassistant.components.weather")
    webhook_component_module = types.ModuleType(
        "homeassistant.components.webhook")
