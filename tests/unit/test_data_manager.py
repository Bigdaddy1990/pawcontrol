...
def test_script_manager_resilience_escalation_definition() -> None:
  ...
  assert fields["statistics_entity_id"][CONF_DEFAULT] == "sensor.pawcontrol_statistics"  # noqa: E111
...
def test_script_manager_resilience_manual_event_snapshot() -> None:
  ...
  assert listener_metadata["pawcontrol_manual_breaker"]["primary_source"] == "blueprint"  # noqa: E111
