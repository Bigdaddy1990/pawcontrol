...
class TestMatchesType:
    ...
    def test_string_matches_string(self) -> None:  # noqa: D102
        assert _matches_type("hello", "string") is True

    def test_integer_matches_integer(self) -> None:  # noqa: D102
        assert _matches_type(5, "integer") is True

    def test_float_does_not_match_integer(self) -> None:  # noqa: D102
        assert _matches_type(5.5, "integer") is False

    def test_float_matches_number(self) -> None:  # noqa: D102
        assert _matches_type(5.5, "number") is True

    def test_integer_matches_number(self) -> None:  # noqa: D102
        assert _matches_type(5, "number") is True

    def test_bool_does_not_match_number(self) -> None:  # noqa: D102
        assert _matches_type(True, "number") is False

    def test_bool_matches_boolean(self) -> None:  # noqa: D102
        assert _matches_type(True, "boolean") is True

    def test_none_matches_null(self) -> None:  # noqa: D102
        assert _matches_type(None, "null") is True

    def test_value_does_not_match_null(self) -> None:  # noqa: D102
        assert _matches_type(0, "null") is False

    def test_list_of_types_accepts_first_match(self) -> None:  # noqa: D102
        assert _matches_type(None, ["string", "null"]) is True

    def test_list_of_types_accepts_second_match(self) -> None:  # noqa: D102
        assert _matches_type("x", ["string", "null"]) is True

    def test_list_of_types_rejects_no_match(self) -> None:  # noqa: D102
        assert _matches_type(5, ["string", "null"]) is False

    def test_unknown_type_string_returns_false(self) -> None:  # noqa: D102
...
class TestValidateJsonSchemaPayload:
    ...
    def test_non_dict_returns_type_violation(self) -> None:  # noqa: D102
    ...
    def test_gps_update_interval_valid(self) -> None:  # noqa: D102
    ...
    def test_gps_options_invalid_gps_source_enum(self) -> None:  # noqa: D102
        payload = {"gps_source": "invalid_source"}
        violations = validate_json_schema_payload(payload, GPS_OPTIONS_JSON_SCHEMA)
        assert any(v.constraint == "enum" for v in violations)

    def test_gps_options_valid_gps_source_enum(self) -> None:  # noqa: D102
        payload = {"gps_source": "device_tracker"}
        violations = validate_json_schema_payload(payload, GPS_OPTIONS_JSON_SCHEMA)
        assert violations == []

    def test_geofence_options_valid_enabled(self) -> None:  # noqa: D102
        payload = {"enabled": True, "use_home": False}
        violations = validate_json_schema_payload(payload, GEOFENCE_OPTIONS_JSON_SCHEMA)
        assert violations == []

    def test_geofence_lat_out_of_range(self) -> None:  # noqa: D102
        payload = {"lat": -200.0}
        violations = validate_json_schema_payload(payload, GEOFENCE_OPTIONS_JSON_SCHEMA)
        assert any(v.field == "lat" for v in violations)

    def test_geofence_radius_below_minimum(self) -> None:  # noqa: D102
        payload = {"radius": 1}
        violations = validate_json_schema_payload(payload, GEOFENCE_OPTIONS_JSON_SCHEMA)
        assert any(
    ...
    def test_geofence_radius_above_maximum(self) -> None:  # noqa: D102
    ...
    def test_mqtt_topic_too_long(self) -> None:  # noqa: D102
    ...
    def test_push_payload_max_bytes_valid(self) -> None:  # noqa: D102
        payload = {"push_payload_max_bytes": 65536}
        violations = validate_json_schema_payload(payload, GPS_OPTIONS_JSON_SCHEMA)
        assert violations == []

    def test_push_payload_max_bytes_too_low(self) -> None:  # noqa: D102
