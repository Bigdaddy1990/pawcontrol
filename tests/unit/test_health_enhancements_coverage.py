...
@pytest.mark.unit
def test_deworming_record_init() -> None:  # noqa: D103
...
@pytest.mark.unit
def test_deworming_type_values() -> None:  # noqa: D103
...
@pytest.mark.unit
def test_enhanced_calculator_vaccination_schedule() -> None:  # noqa: D103
...
@pytest.mark.unit
def test_enhanced_calculator_deworming_schedule() -> None:  # noqa: D103
    schedule = EnhancedHealthCalculator.ADULT_DEWORMING_SCHEDULE
    assert isinstance(schedule, dict)


@pytest.mark.unit
def test_generate_vaccination_schedule() -> None:  # noqa: D103
...
@pytest.mark.unit
def test_generate_deworming_schedule() -> None:  # noqa: D103
    birth = datetime(2022, 6, 1, tzinfo=UTC)
