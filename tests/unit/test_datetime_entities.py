...
class _StubCoordinator:
    ...
    def __init__(self, hass: HomeAssistant) -> None:
        ...
        self.config_entry = SimpleNamespace(
            entry_id="test-entry", data={}, options={})
        self.data: dict[str, dict[str, object]] = {"test_dog": {"health": {}}}
        self.last_update_success = True

    # type: ignore[override]
    def async_add_listener(self, update_callback: object) -> callable:
...
async def test_last_grooming_datetime_localizes_notes(hass: HomeAssistant) -> None:
    ...
    entity._async_call_hass_service = AsyncMock(
    ...
    # type: ignore[attr-defined]
    domain, service, payload = entity._async_call_hass_service.await_args.args
