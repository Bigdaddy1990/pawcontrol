...
@pytest.mark.unit
def test_component_translation_key_simple() -> None:  # noqa: D103
...
@pytest.mark.unit
def test_component_translation_key_with_dots() -> None:  # noqa: D103
    result = component_translation_key("state.feeding_mode.manual")
    assert isinstance(result, str)


@pytest.mark.unit
def test_component_translation_key_empty() -> None:  # noqa: D103
    result = component_translation_key("")
    assert isinstance(result, str)


@pytest.mark.unit
def test_resolve_translation_found() -> None:  # noqa: D103
...
@pytest.mark.unit
def test_resolve_translation_fallback() -> None:  # noqa: D103
    lookup = {}
...
@pytest.mark.unit
def test_resolve_translation_missing_key_returns_default() -> None:  # noqa: D103
    result = resolve_translation({}, {}, "missing.key", default="N/A")
    assert result == "N/A" or isinstance(result, str)


@pytest.mark.unit
def test_resolve_translation_missing_no_default() -> None:  # noqa: D103
    result = resolve_translation({}, {}, "missing.key")
    assert result is None or isinstance(result, str)


@pytest.mark.unit
def test_resolve_component_translation_found() -> None:  # noqa: D103
...
@pytest.mark.unit
def test_resolve_component_translation_empty() -> None:  # noqa: D103
