...
@st.composite
def entity_id_strategy(draw) -> str:
...
class TestGPSValidationProperties:
    ...
    def test_valid_gps_coordinates_always_accepted(self, coords) -> None:  # noqa: E111
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_invalid_latitude_always_rejected(self, invalid_lat) -> None:  # noqa: E111
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_invalid_longitude_always_rejected(self, invalid_lon) -> None:  # noqa: E111
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_gps_validation_idempotent(self, coords1, coords2) -> None:  # noqa: E111
...
class TestDogNameValidationProperties:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_valid_dog_names_accepted(self, name) -> None:  # noqa: E111
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_long_names_rejected(self, long_name) -> None:  # noqa: E111
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_short_names_rejected(self, short_name) -> None:  # noqa: E111
...
class TestRangeValidationProperties:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_value_in_range_accepted(self, min_val, max_val) -> None:  # noqa: E111
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_value_outside_range_rejected(self, value, min_val, max_val) -> None:  # noqa: E111
...
class TestEntityIDValidationProperties:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_valid_entity_ids_accepted(self, entity_id) -> None:  # noqa: E111
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_malformed_entity_ids_rejected(self, text) -> None:  # noqa: E111
...
class TestCoordinatorDiffProperties:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_diff_with_self_shows_no_changes(self, data) -> None:  # noqa: E111
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_diff_symmetry(self, data1, data2) -> None:  # noqa: E111
    ...
    @given(coordinator_data_strategy())  # noqa: E111
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_diff_with_empty_shows_all_added(self, data) -> None:  # noqa: E111
    ...
    @given(coordinator_data_strategy())  # noqa: E111
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_diff_to_empty_shows_all_removed(self, data) -> None:  # noqa: E111
...
class TestDataDiffProperties:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_diff_commutativity_of_unchanged(self, data) -> None:  # noqa: E111
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_single_modification_detected(self, base_data, key, new_value) -> None:  # noqa: E111
...
class TestSerializationRoundTripProperties:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_json_serializable_data_roundtrip(self, data) -> None:  # noqa: E111
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_datetime_serialization_roundtrip(self, dt) -> None:  # noqa: E111
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])  # noqa: E111
    def test_timedelta_serialization_roundtrip(self, td) -> None:  # noqa: E111
