...
class TestGPSValidationProperties:
    ...
    def test_valid_gps_coordinates_always_accepted(self, coords) -> None:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_invalid_latitude_always_rejected(self, invalid_lat) -> None:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_invalid_longitude_always_rejected(self, invalid_lon) -> None:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_gps_validation_idempotent(self, coords1, coords2) -> None:
...
class TestDogNameValidationProperties:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_valid_dog_names_accepted(self, name) -> None:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_long_names_rejected(self, long_name) -> None:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_short_names_rejected(self, short_name) -> None:
...
class TestRangeValidationProperties:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_value_in_range_accepted(self, min_val, max_val) -> None:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_value_outside_range_rejected(self, value, min_val, max_val) -> None:
...
class TestEntityIDValidationProperties:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_valid_entity_ids_accepted(self, entity_id) -> None:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_malformed_entity_ids_rejected(self, text) -> None:
...
class TestCoordinatorDiffProperties:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_diff_with_self_shows_no_changes(self, data) -> None:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_diff_symmetry(self, data1, data2) -> None:
    ...
    @given(coordinator_data_strategy())
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_diff_with_empty_shows_all_added(self, data) -> None:
    ...
    @given(coordinator_data_strategy())
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_diff_to_empty_shows_all_removed(self, data) -> None:
...
class TestDataDiffProperties:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_diff_commutativity_of_unchanged(self, data) -> None:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_single_modification_detected(self, base_data, key, new_value) -> None:
...
class TestSerializationRoundTripProperties:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_json_serializable_data_roundtrip(self, data) -> None:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_datetime_serialization_roundtrip(self, dt) -> None:
    ...
    @settings(suppress_health_check=[HealthCheck.function_scoped_fixture])
    def test_timedelta_serialization_roundtrip(self, td) -> None:
