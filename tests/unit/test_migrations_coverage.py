...
@pytest.mark.unit
def test_normalize_dog_id_replaces_spaces_with_underscores() -> None:
    result = normalize_dog_id("my dog")
    assert "_" in result or result == "my_dog"


@pytest.mark.unit
def test_normalize_dog_id_already_normalised() -> None:
    assert normalize_dog_id("rex_01") == "rex_01"


@pytest.mark.unit
def test_normalize_dog_id_empty_returns_empty() -> None:
...
@pytest.mark.unit
def test_validate_dog_name_not_required_none() -> None:
    result = validate_dog_name(None, required=False)
    assert result is None or isinstance(result, str)


@pytest.mark.unit
def test_validate_dog_name_not_required_empty() -> None:
...
@pytest.mark.unit
def test_ensure_dog_options_entry_with_dog_id() -> None:
