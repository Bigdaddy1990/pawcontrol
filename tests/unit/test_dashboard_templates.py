...
async def test_dog_status_template_accepts_typed_modules(
  ...
  assert any(entity == "binary_sensor.alpha_is_walking" for entity in card["entities"])  # noqa: E111
...
async def test_generate_walk_cards_localizes_german(
  ...
  monkeypatch.setattr(generator.templates, "get_history_graph_template", _fake_history)  # noqa: E111
