...
class TestWalkManagerInitialization:
    ...
    async def test_initialization_empty(self) -> None:
    ...
    async def test_initialization_single_dog(self) -> None:
    ...
    async def test_initialization_multiple_dogs(self) -> None:
...
class TestStartWalk:
    ...
    async def test_start_walk_basic(self, mock_walk_manager) -> None:
    ...
    async def test_start_walk_with_walker(self, mock_walk_manager) -> None:
    ...
    async def test_start_walk_with_weather(self, mock_walk_manager) -> None:
    ...
    async def test_start_walk_with_leash_info(self, mock_walk_manager) -> None:
    ...
    async def test_start_walk_ends_previous_walk(self, mock_walk_manager) -> None:
    ...
    async def test_start_walk_invalid_dog(self, mock_walk_manager) -> None:
...
class TestEndWalk:
    ...
    async def test_end_walk_basic(self, mock_walk_manager, create_walk_event) -> None:
    ...
    async def test_end_walk_with_notes(self, mock_walk_manager) -> None:
    ...
    async def test_end_walk_with_weight(self, mock_walk_manager) -> None:
    ...
    async def test_end_walk_no_active_walk(self, mock_walk_manager) -> None:
    ...
    async def test_end_walk_saves_to_history(self, mock_walk_manager) -> None:
    ...
    async def test_end_walk_clears_active_walk(self, mock_walk_manager) -> None:
...
class TestWalkDuration:
    ...
    async def test_walk_duration_short(self, mock_walk_manager) -> None:
    ...
    async def test_walk_duration_multiple_dogs(self, mock_walk_manager) -> None:
...
class TestWalkStatistics:
    ...
    async def test_get_daily_walk_stats(self, mock_walk_manager) -> None:
    ...
    async def test_get_walk_history(self, mock_walk_manager) -> None:
    ...
    async def test_get_walk_history_with_limit(self, mock_walk_manager) -> None:
    ...
    async def test_weekly_walk_statistics(self, mock_walk_manager) -> None:
...
class TestActiveWalkInfo:
    ...
    async def test_get_active_walk_info(self, mock_walk_manager) -> None:
    ...
    async def test_get_active_walk_info_no_walk(self, mock_walk_manager) -> None:
        """Test getting active walk when no walk active."""
        active_walk = mock_walk_manager.get_active_walk_info("test_dog")

        assert active_walk is None

    async def test_active_walk_duration_updates(self, mock_walk_manager) -> None:
...
class TestWalkTypes:
    ...
    async def test_manual_walk_type(self, mock_walk_manager) -> None:
    ...
    async def test_scheduled_walk_type(self, mock_walk_manager) -> None:
    ...
    async def test_automatic_walk_type(self, mock_walk_manager) -> None:
...
class TestWeatherConditions:
    ...
    def test_weather_condition_from_string(self) -> None:
...
class TestWalkDataRetrieval:
    ...
    async def test_get_walk_data_existing_dog(self, mock_walk_manager) -> None:
    ...
    async def test_get_walk_data_nonexistent_dog(self, mock_walk_manager) -> None:
        """Test getting walk data for non-existent dog."""
        data = mock_walk_manager.get_walk_data("nonexistent")

        assert data is None

    async def test_get_last_walk_info(self, mock_walk_manager) -> None:
...
class TestWalkHistoryManagement:
    ...
    async def test_walk_history_limit(self, mock_walk_manager) -> None:
    ...
    async def test_walk_history_ordered_newest_first(self, mock_walk_manager) -> None:
...
class TestDataIsolation:
    ...
    async def test_walk_data_isolated_between_dogs(self, mock_walk_manager) -> None:
    ...
    async def test_walk_history_isolated(self, mock_walk_manager) -> None:
...
class TestEdgeCases:
    ...
    async def test_end_walk_immediately_after_start(self, mock_walk_manager) -> None:
    ...
    async def test_multiple_start_walk_calls(self, mock_walk_manager) -> None:
    ...
    async def test_concurrent_walks_different_dogs(self, mock_walk_manager) -> None:
    ...
    async def test_walk_with_none_walker(self, mock_walk_manager) -> None:
    ...
    async def test_walk_with_extreme_duration(self, mock_walk_manager) -> None:
    ...
    async def test_cleanup_clears_all_data(self, mock_walk_manager) -> None:
