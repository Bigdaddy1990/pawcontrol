...
if not hasattr(walk_dt_util, "UTC"):
    walk_dt_util.UTC = UTC  # type: ignore[attr-defined]  # noqa: E111
...
class TestWalkManagerInitialization:
    """Test walk manager initialization."""  # noqa: E111

    async def test_initialization_empty(self) -> None:  # noqa: E111
    ...
    async def test_initialization_single_dog(self) -> None:  # noqa: E111
    ...
    async def test_initialization_multiple_dogs(self) -> None:  # noqa: E111
...
@pytest.mark.asyncio
class TestStartWalk:
    """Test starting walk sessions."""  # noqa: E111

    async def test_start_walk_basic(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_start_walk_with_walker(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_start_walk_with_weather(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_start_walk_with_leash_info(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_start_walk_ends_previous_walk(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_start_walk_invalid_dog(self, mock_walk_manager) -> None:  # noqa: E111
        """Test starting walk for non-existent dog."""
        with pytest.raises(KeyError):
            await mock_walk_manager.async_start_walk(  # noqa: E111
                dog_id="nonexistent",
                walk_type="manual",
            )
...
@pytest.mark.asyncio
class TestEndWalk:
    """Test ending walk sessions."""  # noqa: E111

    async def test_end_walk_basic(self, mock_walk_manager, create_walk_event) -> None:  # noqa: E111
    ...
    async def test_end_walk_with_notes(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_end_walk_with_weight(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_end_walk_no_active_walk(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_end_walk_saves_to_history(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_end_walk_clears_active_walk(self, mock_walk_manager) -> None:  # noqa: E111
...
class TestWalkDuration:
    """Test walk duration calculations."""  # noqa: E111

    async def test_walk_duration_short(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_walk_duration_multiple_dogs(self, mock_walk_manager) -> None:  # noqa: E111
...
class TestWalkStatistics:
    """Test walk statistics and aggregation."""  # noqa: E111

    async def test_get_daily_walk_stats(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_get_walk_history(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_get_walk_history_with_limit(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_weekly_walk_statistics(self, mock_walk_manager) -> None:  # noqa: E111
        ...
        for i in range(7):
            ...
            walk = await mock_walk_manager.async_end_walk(  # noqa: E111
                dog_id="test_dog",
            )

            # Modify timestamp to simulate different days  # noqa: E114
            if hasattr(walk, "start_time"):  # noqa: E111
...
class TestActiveWalkInfo:
    """Test active walk information."""  # noqa: E111

    async def test_get_active_walk_info(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_get_active_walk_info_no_walk(self, mock_walk_manager) -> None:  # noqa: E111
        """Test getting active walk when no walk active."""
        active_walk = mock_walk_manager.get_active_walk_info("test_dog")

        assert active_walk is None

    async def test_active_walk_duration_updates(self, mock_walk_manager) -> None:  # noqa: E111
...
@pytest.mark.asyncio
class TestWalkTypes:
    """Test different walk types."""  # noqa: E111

    async def test_manual_walk_type(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_scheduled_walk_type(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_automatic_walk_type(self, mock_walk_manager) -> None:  # noqa: E111
...
class TestWeatherConditions:
    """Test weather condition enum."""  # noqa: E111

    def test_weather_condition_enum_values(self) -> None:  # noqa: E111
    ...
    def test_weather_condition_from_string(self) -> None:  # noqa: E111
...
class TestWalkDataRetrieval:
    """Test walk data retrieval methods."""  # noqa: E111

    async def test_get_walk_data_existing_dog(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_get_walk_data_nonexistent_dog(self, mock_walk_manager) -> None:  # noqa: E111
        """Test getting walk data for non-existent dog."""
        data = mock_walk_manager.get_walk_data("nonexistent")

        assert data is None

    async def test_get_last_walk_info(self, mock_walk_manager) -> None:  # noqa: E111
...
class TestWalkHistoryManagement:
    """Test walk history management and limits."""  # noqa: E111

    async def test_walk_history_limit(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_walk_history_ordered_newest_first(self, mock_walk_manager) -> None:  # noqa: E111
        ...
        if len(history) >= 2:
            first_timestamp = history[0].get("start_time", datetime.now(UTC))  # noqa: E111
            second_timestamp = history[1].get("start_time", datetime.now(UTC))  # noqa: E111
            assert first_timestamp >= second_timestamp  # noqa: E111


@pytest.mark.unit
@pytest.mark.asyncio
class TestDataIsolation:
    """Test that walk data is isolated between dogs."""  # noqa: E111

    async def test_walk_data_isolated_between_dogs(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_walk_history_isolated(self, mock_walk_manager) -> None:  # noqa: E111
...
class TestEdgeCases:
    ...
    async def test_end_walk_immediately_after_start(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_multiple_start_walk_calls(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_concurrent_walks_different_dogs(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_walk_with_none_walker(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_walk_with_extreme_duration(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_cleanup_clears_all_data(self, mock_walk_manager) -> None:  # noqa: E111
...
def _build_export_snapshot(
    *,
    ...
    """Create a typed walk snapshot for export regression tests."""  # noqa: E111

    start_ts = start.isoformat()  # noqa: E111
    end_ts = (start + timedelta(seconds=duration)).isoformat()  # noqa: E111
    ...
    if include_invalid_point:  # noqa: E111
        path.append({
            "latitude": 123.456,
            "longitude": 789.012,
    ...
    snapshot: WalkSessionSnapshot = {  # noqa: E111
        "walk_id": walk_id,
        "dog_id": "test_dog",
        "walk_type": "manual",
        "start_time": start_ts,
...
class TestRouteExport:
    """Validate typed walk route exports."""  # noqa: E111

    async def test_export_routes_gpx_payload(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_export_routes_json_payload(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_export_routes_csv_payload(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_export_routes_without_history(self, mock_walk_manager) -> None:  # noqa: E111
    ...
    async def test_export_routes_limits_recent_walks(self, mock_walk_manager) -> None:  # noqa: E111
