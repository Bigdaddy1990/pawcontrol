...
@pytest.mark.unit
def test_coerce_meals_per_day_none_returns_default() -> None:  # noqa: D103
    assert FeedingOptionsMixin._coerce_meals_per_day(None, 2) == 2


@pytest.mark.unit
def test_coerce_meals_per_day_valid_int() -> None:  # noqa: D103
    assert FeedingOptionsMixin._coerce_meals_per_day(3, 2) == 3


@pytest.mark.unit
def test_coerce_meals_per_day_clamps_min() -> None:  # noqa: D103
    assert FeedingOptionsMixin._coerce_meals_per_day(0, 2) == 1


@pytest.mark.unit
def test_coerce_meals_per_day_clamps_max() -> None:  # noqa: D103
    assert FeedingOptionsMixin._coerce_meals_per_day(10, 2) == 6


@pytest.mark.unit
def test_coerce_meals_per_day_invalid_string_returns_default() -> None:  # noqa: D103
    assert FeedingOptionsMixin._coerce_meals_per_day("bad", 3) == 3


@pytest.mark.unit
def test_coerce_meals_per_day_float_string() -> None:  # noqa: D103
    # "3.5" → int(3.5) raises ValueError → default
    assert FeedingOptionsMixin._coerce_meals_per_day("3.5", 2) == 2


@pytest.mark.unit
def test_coerce_meals_per_day_valid_string_int() -> None:  # noqa: D103
    assert FeedingOptionsMixin._coerce_meals_per_day("4", 2) == 4


@pytest.mark.unit
def test_coerce_meals_per_day_none_type() -> None:  # noqa: D103
