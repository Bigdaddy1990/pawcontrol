...
@pytest.mark.unit
def test_fv_validate_dog_name_valid() -> None:  # noqa: D103
    result = validate_dog_name("Rex")
    assert result == "Rex"


@pytest.mark.unit
def test_fv_validate_dog_name_stripped() -> None:  # noqa: D103
    result = validate_dog_name("  Buddy  ")
    assert result == "Buddy"


@pytest.mark.unit
def test_fv_validate_dog_name_too_short_raises() -> None:  # noqa: D103
    with pytest.raises((ValidationError, Exception)):
        validate_dog_name("R", min_length=2)


@pytest.mark.unit
def test_fv_validate_dog_name_not_required_none() -> None:  # noqa: D103
...
@pytest.mark.unit
def test_validate_gps_coords_valid() -> None:  # noqa: D103
...
@pytest.mark.unit
def test_validate_gps_coords_invalid_lat_raises() -> None:  # noqa: D103
    with pytest.raises((ValidationError, Exception)):
        validate_flow_gps_coordinates(999.0, 13.40)


@pytest.mark.unit
def test_validate_gps_coords_invalid_lon_raises() -> None:  # noqa: D103
    with pytest.raises((ValidationError, Exception)):
...
@pytest.mark.unit
def test_validate_geofence_radius_valid() -> None:  # noqa: D103
...
@pytest.mark.unit
def test_validate_geofence_radius_too_small_raises() -> None:  # noqa: D103
    with pytest.raises((ValidationError, Exception)):
        validate_flow_geofence_radius(
...
@pytest.mark.unit
def test_validate_geofence_radius_none_not_required() -> None:  # noqa: D103
    result = validate_flow_geofence_radius(
...
@pytest.mark.unit
def test_calculate_optimal_update_interval_walk() -> None:  # noqa: D103
...
@pytest.mark.unit
def test_calculate_optimal_update_interval_feeding_low() -> None:  # noqa: D103
...
@pytest.mark.unit
def test_calculate_optimal_update_interval_default_volatility() -> None:  # noqa: D103
...
@pytest.mark.unit
def test_estimate_state_write_reduction_basic() -> None:  # noqa: D103
    result = estimate_state_write_reduction(100, 60)
    assert isinstance(result, dict)


@pytest.mark.unit
def test_estimate_state_write_reduction_no_reduction() -> None:  # noqa: D103
    result = estimate_state_write_reduction(50, 50)
    assert isinstance(result, dict)


@pytest.mark.unit
def test_estimate_state_write_reduction_full_reduction() -> None:  # noqa: D103
