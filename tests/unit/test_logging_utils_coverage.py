...
@pytest.mark.unit
def test_redact_sensitive_password() -> None:
...
@pytest.mark.unit
def test_redact_sensitive_api_key() -> None:
...
@pytest.mark.unit
def test_redact_sensitive_no_sensitive_keys() -> None:
...
@pytest.mark.unit
def test_redact_value_sensitive_key() -> None:
    result = redact_value("password", "my_secret")
    assert result != "my_secret"


@pytest.mark.unit
def test_redact_value_safe_key() -> None:
    result = redact_value("dog_name", "Rex")
    assert result == "Rex"


@pytest.mark.unit
def test_redact_value_none_value() -> None:
