...
@pytest.mark.unit
def test_normalize_value_float_passthrough() -> None:
...
@pytest.mark.unit
def test_normalize_value_none_passthrough() -> None:
    assert normalize_value(None) is None


@pytest.mark.unit
def test_normalize_value_bool_passthrough() -> None:
...
@pytest.mark.unit
def test_normalize_value_nested_dict() -> None:
