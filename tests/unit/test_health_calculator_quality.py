...
class TestLifeStageCalculation:
  ...
  def test_life_stage_thresholds(self) -> None:
    ...
    assert HealthCalculator.calculate_life_stage(20, "medium") == LifeStage.YOUNG_ADULT
    ...
    assert HealthCalculator.calculate_life_stage(130, "medium") == LifeStage.GERIATRIC
