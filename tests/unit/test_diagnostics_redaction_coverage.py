...
@pytest.mark.unit
def test_compile_redaction_patterns_basic_keys() -> None:
    patterns = compile_redaction_patterns(["password", "api_key", "token"])
    assert patterns is not None


@pytest.mark.unit
def test_compile_redaction_patterns_single_key() -> None:
...
@pytest.mark.unit
def test_redact_sensitive_data_keeps_safe_keys() -> None:
...
@pytest.mark.unit
def test_redact_sensitive_data_no_sensitive_keys() -> None:
    patterns = compile_redaction_patterns(["password"])
...
@pytest.mark.unit
def test_redact_sensitive_data_none_value() -> None:
    patterns = compile_redaction_patterns(["password"])
