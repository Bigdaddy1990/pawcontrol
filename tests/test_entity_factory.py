...
class TestEntityFactory:
    ...
    def test_entity_priorities_completeness(self):
        ...
        essential_entities = [
            "last_feeding", "feeding_schedule_adherence", "health_aware_portion",
            "last_walk", "walk_count_today", "current_zone", "distance_from_home",
    ...
    def test_create_core_entities(self, mock_activity, mock_action, mock_status, entity_factory):
    ...
    @patch('custom_components.pawcontrol.sensor.PawControlFeedingScheduleAdherenceSensor')
    @patch('custom_components.pawcontrol.sensor.PawControlHealthAwarePortionSensor')
    def test_create_feeding_entities_basic(self, mock_portion, mock_adherence, mock_last, entity_factory):
        ...
        entities = entity_factory._create_feeding_entities("test_dog", "Test Dog", "basic")
    ...
    def test_create_feeding_entities_standard(self, mock_rec, mock_cal, mock_total, 
                                            mock_portion, mock_adherence, mock_last, entity_factory):
        """Test creation of feeding entities for standard profile."""
        # Mock all sensor classes
        for mock_sensor in [mock_last, mock_adherence, mock_portion, mock_total, mock_cal, mock_rec]:
            mock_sensor.return_value = Mock()
        
        entities = entity_factory._create_feeding_entities("test_dog", "Test Dog", "standard")
    ...
    def test_create_health_entities_basic(self, mock_weight, mock_status, entity_factory):
        """Test creation of health entities for basic profile."""
        mock_status.return_value = Mock()
        mock_weight.return_value = Mock()
        
        entities = entity_factory._create_health_entities("test_dog", "Test Dog", "basic")
    ...
    @patch('custom_components.pawcontrol.entity_factory.EntityFactory._create_core_entities')
    @patch('custom_components.pawcontrol.entity_factory.EntityFactory._create_feeding_entities')
    @patch('custom_components.pawcontrol.entity_factory.EntityFactory._create_walk_entities')
    @patch('custom_components.pawcontrol.entity_factory.EntityFactory._create_gps_entities')
    @patch('custom_components.pawcontrol.entity_factory.EntityFactory._create_health_entities')
    def test_create_entities_for_dog_standard_profile(self, mock_health, mock_gps, mock_walk, 
                                                    mock_feeding, mock_core, entity_factory):
        ...
        assert len(entities) == 8  # Based on mock returns
    ...
    @patch('custom_components.pawcontrol.entity_factory.EntityFactory._create_core_entities')
    @patch('custom_components.pawcontrol.entity_factory.EntityFactory._create_feeding_entities')
    def test_create_entities_for_dog_selective_modules(self, mock_feeding, mock_core, entity_factory):
    ...
    def test_create_entities_for_dog_entity_limit_enforcement(self, entity_factory):
        ...
        with patch.object(entity_factory, '_create_core_entities', return_value=many_entities):
            entities = entity_factory.create_entities_for_dog(
    ...
    def test_create_entities_for_dog_priority_sorting(self, entity_factory):
        ...
        with patch.object(entity_factory, '_create_core_entities', return_value=mixed_priority_entities):
            entities = entity_factory.create_entities_for_dog(
    ...
    def test_profile_performance_characteristics(self, entity_factory):
        ...
        improvement_standard_to_advanced = (advanced_count - standard_count) / standard_count
...
class TestEntityFactoryIntegration:
    ...
    def test_integration_basic_profile_real_entities(self, entity_factory):
        ...
        modules = {MODULE_FEEDING: True, MODULE_WALK: False, MODULE_GPS: False, MODULE_HEALTH: False}
