...
class TestDietValidationIntegration:
    ...
    def feeding_config_with_validation(self, sample_diet_validation) -> FeedingConfig:
        ...
        return FeedingConfig(
            ...
            special_diet=["puppy_formula", "senior_formula", "diabetic", "kidney_support"],
    ...
    def test_feeding_config_stores_diet_validation(self, sample_diet_validation) -> None:
...
class TestFeedingManagerDietValidation:
    ...
    async def test_async_update_diet_validation(
        ...
        status = await manager_with_validation.async_get_diet_validation_status("test_dog")
    ...
    async def test_async_get_diet_validation_status_no_validation(
        self
    ) -> None:
    ...
    async def test_async_validate_portion_with_diet(
        ...
        # Verify structure
        required_keys = [
            "portion", "meal_type", "safety_validation", 
            "diet_validation_summary", "health_aware_calculation", "config_id"
        ]
    ...
    async def test_async_validate_portion_with_diet_error_handling(
        self
    ) -> None:
    ...
    async def test_feeding_with_diet_validation_logging(
        ...
        await manager_with_validation.async_add_feeding(
            "test_dog", 180.0, "breakfast"
        )
...
class TestComplexDietScenarios:
    ...
    async def test_senior_diabetic_dog_complex_diet(
        self
    ) -> None:
        ...
        dogs = [{
            ...
            "feeding_config": {
                ...
                "special_diet": [
                    "senior_formula", "diabetic", "low_fat", 
                    "joint_support", "prescription"
                ],
                "health_aware_portions": True,
                "dog_weight": 18.0,
    ...
    async def test_puppy_with_conflicting_diets(
        self
    ) -> None:
    ...
    async def test_raw_diet_with_medical_conditions(
        self
    ) -> None:
        ...
        assert "monitoring" in safety_recs.lower() or "veterinary" in safety_recs.lower()
