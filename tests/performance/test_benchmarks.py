...
class TestCoordinatorPerformance:
    ...
    async def test_coordinator_data_access_performance(self):
        ...
        assert result.meets_target(
            1.0), f"Data access too slow: {result.avg_ms:.2f}ms"
...
class TestValidationPerformance:
    ...
    def test_gps_validation_performance(self):
        ...
        print(f"\n{result}")
        assert result.meets_target(
            0.1), f"GPS validation too slow: {result.avg_ms:.2f}ms"
    ...
    def test_dog_name_validation_performance(self):
        ...
        print(f"\n{result}")
        assert result.meets_target(
            0.1), f"Name validation too slow: {result.avg_ms:.2f}ms"
...
class TestDiffingPerformance:
    ...
    def test_coordinator_diff_performance(self):
        ...
        print(f"\n{result}")
        assert result.meets_target(
            5.0), f"Diffing too slow: {result.avg_ms:.2f}ms"
    ...
    def test_diff_large_dataset_performance(self):
        ...
        print(f"\n{result}")
        assert result.meets_target(
            50.0), f"Large diff too slow: {result.avg_ms:.2f}ms"
...
class TestSerializationPerformance:
    ...
    def test_coordinator_data_serialization(self):
        ...
        print(f"\n{result}")
        assert result.meets_target(
            10.0), f"Serialization too slow: {result.avg_ms:.2f}ms"
