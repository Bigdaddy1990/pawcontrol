...
class TestNotificationManagerBasics:
    ...
    async def test_initialization_success(
        ...
        with (
            patch.object(notification_manager, "_start_background_tasks"),
    ...
    async def test_shutdown_graceful(self, hass: HomeAssistant, initialized_manager):
        ...
        with patch.object(
            manager, "_dismiss_notification_internal", return_value=True
        ) as mock_dismiss:
    ...
    async def test_configuration_loading(
        self, hass: HomeAssistant, notification_manager, mock_runtime_data
    ):
...
class TestCoreNotificationFunctionality:
    ...
    async def test_send_basic_notification_success(
        self, hass: HomeAssistant, initialized_manager, mock_persistent_notification
    ):
        ...
        with patch.object(manager, "_send_persistent_notification", return_value=True):
            result = await manager.async_send_notification(
                "test_dog", NOTIFICATION_FEEDING, "Time to feed your dog!"
            )
    ...
    async def test_send_notification_with_all_options(
        self, hass: HomeAssistant, initialized_manager
    ):
    ...
    async def test_send_notification_validation_failure(
        self, hass: HomeAssistant, initialized_manager
    ):
        ...
        # Test empty dog_id
        result = await manager.async_send_notification(
            "", NOTIFICATION_FEEDING, "Test message"
        )
        assert result is False

        # Test empty notification_type
        result = await manager.async_send_notification("test_dog", "", "Test message")
        assert result is False
    ...
    async def test_send_notification_disabled_globally(
        self, hass: HomeAssistant, initialized_manager
    ):
        ...
        result = await manager.async_send_notification(
            "test_dog", NOTIFICATION_FEEDING, "Test message"
        )

        assert result is False
        assert manager._metrics["notifications_sent"] == 0

    async def test_send_notification_force_override(
        self, hass: HomeAssistant, initialized_manager
    ):
        ...
        with patch.object(manager, "_send_persistent_notification", return_value=True):
            result = await manager.async_send_notification(
                "test_dog", NOTIFICATION_SYSTEM, "Forced message", force=True
            )
...
class TestPriorityManagement:
    ...
    async def test_urgent_priority_bypasses_quiet_hours(
        self, hass: HomeAssistant, initialized_manager
    ):
        ...
        with (
            ...
            result_urgent = await manager.async_send_notification(
                "test_dog", NOTIFICATION_SAFETY, "Emergency!", priority=PRIORITY_URGENT
            )
            assert result_urgent is True

    async def test_urgent_priority_bypasses_rate_limiting(
        self, hass: HomeAssistant, initialized_manager
    ):
    ...
    async def test_priority_affects_delivery_methods(
        self, hass: HomeAssistant, initialized_manager
    ):
    ...
    async def test_title_generation_with_priority(
        ...
        title_urgent = notification_manager._generate_title(
            "Buddy", NOTIFICATION_FEEDING, PRIORITY_URGENT
        )
        title_high = notification_manager._generate_title(
            "Buddy", NOTIFICATION_FEEDING, PRIORITY_HIGH
        )
        title_normal = notification_manager._generate_title(
            "Buddy", NOTIFICATION_FEEDING, PRIORITY_NORMAL
        )
        title_low = notification_manager._generate_title(
            "Buddy", NOTIFICATION_FEEDING, PRIORITY_LOW
        )
...
class TestQuietHours:
    ...
    async def test_quiet_hours_detection(
        ...
        with patch(
            "custom_components.pawcontrol.utils.is_within_quiet_hours"
        ) as mock_quiet:
    ...
    async def test_quiet_hours_disabled(
        self, hass: HomeAssistant, notification_manager
    ):
    ...
    async def test_notification_suppression_during_quiet_hours(
        self, hass: HomeAssistant, initialized_manager
    ):
        ...
        with patch.object(manager, "_is_in_quiet_hours", return_value=True):
            # Normal priority should be suppressed
            result = await manager.async_send_notification(
                "test_dog", NOTIFICATION_WALK, "Walk time!", priority=PRIORITY_NORMAL
            )
...
class TestRateLimiting:
    ...
    async def test_rate_limiting_by_priority(
        self, hass: HomeAssistant, initialized_manager
    ):
    ...
    async def test_different_notification_types_not_rate_limited(
        self, hass: HomeAssistant, initialized_manager
    ):
        ...
        with patch.object(manager, "_send_persistent_notification", return_value=True):
            ...
            result1 = await manager.async_send_notification(
                "test_dog", NOTIFICATION_FEEDING, "Feeding time"
            )
            assert result1 is True

            # Send walk notification (different type, should not be rate limited)
            result2 = await manager.async_send_notification(
                "test_dog", NOTIFICATION_WALK, "Walk time"
            )
            assert result2 is True

    async def test_different_dogs_not_rate_limited(
        self, hass: HomeAssistant, initialized_manager
    ):
        ...
        with (
            ...
            result1 = await manager.async_send_notification(
                "dog_1", NOTIFICATION_FEEDING, "Feeding time"
            )
            assert result1 is True

            # Send notification for second dog (should not be rate limited)
            result2 = await manager.async_send_notification(
                "dog_2", NOTIFICATION_FEEDING, "Feeding time"
            )
            assert result2 is True
    ...
    async def test_rate_limiting_disabled(
        ...
        with patch.object(manager, "_send_persistent_notification", return_value=True):
            ...
            for i in range(5):
                result = await manager.async_send_notification(
                    "test_dog", NOTIFICATION_FEEDING, f"Feeding {i}"
                )
                assert result is True
...
class TestDeliveryMethods:
    ...
    async def test_persistent_notification_delivery(
        self, hass: HomeAssistant, initialized_manager, mock_persistent_notification
    ):
    ...
    async def test_persistent_notification_failure(
        self, hass: HomeAssistant, initialized_manager, mock_persistent_notification
    ):
        """Test persistent notification failure handling."""
        manager = await initialized_manager()
        mock_persistent_notification["create"].side_effect = Exception(
            "Persistent error"
        )
    ...
    async def test_mobile_app_notification_delivery(
        self, hass: HomeAssistant, initialized_manager, mock_hass_services
    ):
    ...
    async def test_mobile_app_no_services_available(
        self, hass: HomeAssistant, initialized_manager
    ):
    ...
    async def test_delivery_method_failure_handling(
        self, hass: HomeAssistant, initialized_manager
    ):
        ...
        with (
            ...
            patch.object(
                ...
                side_effect=Exception("Mobile error"),
            ),
        ):
            result = await manager.async_send_notification(
                "test_dog",
...
class TestTestNotifications:
    ...
    async def test_send_test_notification_success(
        ...
        with patch.object(
            manager, "async_send_notification", return_value=True
        ) as mock_send:
    ...
    async def test_send_test_notification_with_custom_params(
        self, hass: HomeAssistant, initialized_manager
    ):
        ...
        with patch.object(
            ...
            result = await manager.async_send_test_notification(
                "test_dog", message="Custom test message", priority=PRIORITY_HIGH
            )
...
class TestBackgroundTasks:
    ...
    async def test_background_cleanup_task_start(
        self, hass: HomeAssistant, initialized_manager
    ):
    ...
    async def test_cleanup_max_history_count(
        self, hass: HomeAssistant, initialized_manager
    ):
...
class TestUtilityMethods:
    ...
    async def test_generate_notification_id(
        self, hass: HomeAssistant, notification_manager
    ):
    ...
    async def test_get_dog_name_with_coordinator_data(
        self, hass: HomeAssistant, notification_manager, mock_runtime_data
    ):
    ...
    async def test_get_dog_name_fallback(
        self, hass: HomeAssistant, notification_manager
    ):
    ...
    async def test_get_delivery_methods_default(
        self, hass: HomeAssistant, notification_manager
    ):
        ...
        methods = await manager._get_delivery_methods(
            "test_dog", NOTIFICATION_FEEDING, PRIORITY_NORMAL
        )

        assert methods == [DELIVERY_PERSISTENT]

    async def test_get_delivery_methods_priority_enhancement(
        self, hass: HomeAssistant, notification_manager
    ):
        ...
        # High priority should add mobile app
        methods_high = await manager._get_delivery_methods(
            "test_dog", NOTIFICATION_WALK, PRIORITY_HIGH
        )
        assert DELIVERY_MOBILE_APP in methods_high

        # Urgent priority should add multiple methods
        methods_urgent = await manager._get_delivery_methods(
            "test_dog", NOTIFICATION_SAFETY, PRIORITY_URGENT
        )
    ...
    async def test_dismiss_notification_success(
        ...
        mock_persistent_notification["dismiss"].assert_called_once_with(
...
class TestErrorHandling:
    ...
    async def test_send_notification_critical_error(
        self, hass: HomeAssistant, initialized_manager
    ):
        ...
        with patch.object(
            manager, "_get_delivery_methods", side_effect=Exception("Critical error")
        ):
            with pytest.raises(NotificationError) as exc_info:
                await manager.async_send_notification(
                    "test_dog", NOTIFICATION_FEEDING, "Test message"
    ...
    async def test_notification_with_corrupted_runtime_data(
        self, hass: HomeAssistant, notification_manager
    ):
        ...
        with patch.object(
            manager, "_get_runtime_data", side_effect=Exception("Data corruption")
        ):
            await manager.async_initialize()

            # Should still be able to send notifications with fallback
            with patch.object(
                manager, "_send_persistent_notification", return_value=True
            ):
                result = await manager.async_send_notification(
                    "unknown_dog", NOTIFICATION_SYSTEM, "Test message"
                )

                assert result is True

    async def test_notification_with_invalid_dog_id_characters(
        self, hass: HomeAssistant, initialized_manager
    ):
        ...
        with patch.object(manager, "_send_persistent_notification", return_value=True):
            result = await manager.async_send_notification(
                "dog-with-special-chars_123!@#", NOTIFICATION_FEEDING, "Test message"
            )
...
class TestPerformanceCharacteristics:
    ...
    async def test_large_notification_history_performance(
        self, hass: HomeAssistant, initialized_manager
    ):
    ...
    async def test_memory_usage_with_many_active_notifications(
        self, hass: HomeAssistant, initialized_manager
    ):
        ...
        with patch.object(manager, "_send_persistent_notification", return_value=True):
            for i in range(100):
                await manager.async_send_notification(
                    f"dog_{i}", NOTIFICATION_SYSTEM, f"Message {i}", force=True
                )
...
class TestNotificationIntegration:
    ...
    async def test_integration_with_hass_services(
        self, hass: HomeAssistant, initialized_manager, mock_hass_services
    ):
        ...
        with patch.object(
            manager, "_send_mobile_app_notification", return_value=True
        ) as mock_mobile:
            await manager.async_send_notification(
                "test_dog",
                NOTIFICATION_WALK,
    ...
    async def test_persistent_notification_integration(
        self, hass: HomeAssistant, initialized_manager, mock_persistent_notification
    ):
...
class TestConfigurationAndState:
    ...
    async def test_dog_specific_settings(
        self, hass: HomeAssistant, notification_manager
    ):
        ...
        enabled = await manager._is_notification_enabled(
            "special_dog", NOTIFICATION_FEEDING, force=False
        )
        assert enabled is False  # Disabled at dog level

        # Test force override
        enabled_force = await manager._is_notification_enabled(
            "special_dog", NOTIFICATION_FEEDING, force=True
        )
    ...
    async def test_metrics_tracking(self, hass: HomeAssistant, initialized_manager):
        ...
        with patch.object(
            manager, "_send_persistent_notification", side_effect=Exception("Error")
        ):
            await manager.async_send_notification(
                "another_dog", NOTIFICATION_WALK, "Walk message"
            )
