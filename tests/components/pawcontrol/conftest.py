"""Component-level fixtures for PawControl tests."""
...
def ensure_config_flow_registered() -> Iterator[None]:
    ...
    module = _reload_config_flow_module()

    try:
        from homeassistant.exceptions import ConfigEntryNotReady
    except Exception:  # pragma: no cover - Home Assistant not present
        pass
    else:
        module.ConfigEntryNotReady = ConfigEntryNotReady
    yield
