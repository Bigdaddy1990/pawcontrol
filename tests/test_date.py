...
class TestAsyncSetupEntry:
    ...
    @pytest.mark.asyncio
    async def test_async_setup_entry_with_errors(self, hass: HomeAssistant, mock_coordinator):
...
class TestPawControlDateBase:
    ...
    def test_extra_state_attributes_birthdate_age_calculation(self, mock_coordinator):
        ...
        today = dt_util.now().date()
        birth_date = today - timedelta(days=365 * 2 + 30)  # ~2 years and 1 month old
    ...
    @pytest.mark.asyncio
    async def test_async_added_to_hass_without_previous_state(self, hass: HomeAssistant, base_date_entity):
    ...
    @pytest.mark.asyncio
    async def test_async_added_to_hass_with_valid_previous_state(self, hass: HomeAssistant, base_date_entity):
        ...
        with patch.object(base_date_entity, 'async_get_last_state', return_value=mock_state):
            await base_date_entity.async_added_to_hass()
            
        assert base_date_entity._current_value == date(2023, 6, 15)

    @pytest.mark.asyncio
    async def test_async_added_to_hass_with_invalid_previous_state(self, hass: HomeAssistant, base_date_entity):
    ...
    @pytest.mark.asyncio
    async def test_async_added_to_hass_with_unknown_state(self, hass: HomeAssistant, base_date_entity):
    ...
    @pytest.mark.asyncio
    async def test_async_set_value_valid_date(self, hass: HomeAssistant, base_date_entity):
        ...
        with patch.object(base_date_entity, 'async_write_ha_state') as mock_write_state:
            with patch.object(base_date_entity, '_async_handle_date_set', new_callable=AsyncMock) as mock_handle:
    ...
    @pytest.mark.asyncio
    async def test_async_set_value_invalid_type(self, hass: HomeAssistant, base_date_entity):
    ...
    @pytest.mark.asyncio
    async def test_async_set_value_with_exception_in_handler(self, hass: HomeAssistant, base_date_entity):
        """Test setting value when handler raises exception."""
        base_date_entity.hass = hass
        test_date = date(2023, 7, 20)
        
        with patch.object(base_date_entity, '_async_handle_date_set', side_effect=Exception("Handler error")):
            with pytest.raises(ValidationError) as exc_info:
                await base_date_entity.async_set_value(test_date)
    ...
    def test_handle_coordinator_update_with_data(self, base_date_entity, mock_coordinator):
        ...
        with patch.object(base_date_entity, '_extract_date_from_dog_data', return_value=test_date):
            base_date_entity._handle_coordinator_update()
        
        assert base_date_entity._current_value == test_date

    def test_handle_coordinator_update_no_data(self, base_date_entity, mock_coordinator):
    ...
    def test_handle_coordinator_update_same_date(self, base_date_entity, mock_coordinator):
    ...
    def test_handle_coordinator_update_with_exception(self, base_date_entity, mock_coordinator):
...
class TestPawControlLastVetVisitDate:
    ...
    def test_extract_date_from_dog_data_datetime_string(self, vet_visit_entity):
        ...
        dog_data = {
            "health": {
                "last_vet_visit": "2023-05-15T10:30:00"
            }
        }
    ...
    @pytest.mark.asyncio
    async def test_async_handle_date_set_vet_visit(self, hass: HomeAssistant, vet_visit_entity):
    ...
    @pytest.mark.asyncio
    async def test_async_handle_date_set_service_error(self, hass: HomeAssistant, vet_visit_entity):
...
class TestPawControlVaccinationDate:
    ...
    @pytest.mark.asyncio
    async def test_async_handle_date_set_vaccination(self, hass: HomeAssistant, vaccination_entity):
...
class TestPawControlDewormingDate:
    ...
    @pytest.mark.asyncio
    async def test_async_handle_date_set_deworming(self, hass: HomeAssistant, deworming_entity):
...
class TestPawControlGroomingDate:
    ...
    def test_extract_date_from_dog_data_grooming(self, last_grooming_entity):
        ...
        dog_data = {
            "health": {
                "last_grooming": "2023-04-20T14:00:00"
            }
        }
    ...
    async def test_performance_with_many_entities(self, mock_coordinator):
        ...
        for dog_num in range(10):
            ...
            entities.extend([
                ...
                PawControlNextVetAppointmentDate(mock_coordinator, dog_id, dog_name),
