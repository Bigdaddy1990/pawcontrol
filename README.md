...
Support tooling also receives a dedicated `setup_flags_panel` snapshot that surfaces analytics, cloud-backup, and debug-logging toggles with translation keys, source metadata, and enabled/disabled counts so dashboards can render the onboarding state without custom parsing.【F:custom_components/pawcontrol/diagnostics.py†L120-L210】【F:custom_components/pawcontrol/strings.json†L1396-L1407】【F:tests/components/pawcontrol/test_diagnostics.py†L288-L405】
