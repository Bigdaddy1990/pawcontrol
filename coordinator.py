...
class PawControlCoordinator(DataUpdateCoordinator[dict[str, Any]]):
    ...
    # FIXED: Add missing method called by button.py
    async def async_request_selective_refresh(
        ...
        Args:
            dog_ids: List of dog IDs to refresh
        ...
        # In a future version, this could be optimized to only update specific dogs
