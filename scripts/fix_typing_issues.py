#!/usr/bin/env python3
"""Auto-fix common MyPy issues in the PawControl codebase.

The script runs MyPy, applies safe text-level fixes for selected error codes,
and re-runs MyPy for a configurable number of rounds.

Usage:
    python -m scripts.fix_typing_issues --apply
    python -m scripts.fix_typing_issues --paths custom_components/pawcontrol
"""
