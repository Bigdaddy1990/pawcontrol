...
REDUNDANT_CAST_FIXES = [
    ...
    ErrorFix(
        ...
        "redundant-cast",
        "Mapping",
        r"cast\(Mapping\[str, Any\] \| dict\[str, JSONValue\], ([^)]+)\)",
        r"\1",
    ),
    ErrorFix(
...
def main() -> None:
    ...
    parser.add_argument(
        "--backup", action="store_true", help="Create backup before applying"
    )
