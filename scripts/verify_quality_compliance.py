...
INTEGRATION_ROOT: Final[Path] = Path(__file__).parent.parent / "custom_components" / "pawcontrol"
...
class QualityVerifier:
    ...
    def verify_validation_centralization(self) -> None:
        ...
        for py_file in INTEGRATION_ROOT.glob("*.py"):
            if py_file.name in ("validation.py", "flow_validation.py", "validation_helpers.py"):
                continue
