...
| diagnostics | `custom_components/pawcontrol/diagnostics.py`, `docs/diagnostics.md` | `tests/test_diagnostics.py`, `tests/unit/test_diagnostics_cache.py`, `tests/unit/test_services.py` | @BigDaddy1990 |
