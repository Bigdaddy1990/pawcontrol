...
WEATHER_ALERT_KEYS: Final[tuple[WeatherAlertKey, ...]] = cast(
  tuple[WeatherAlertKey, ...],
  get_args(WeatherAlertKey),
)

WEATHER_RECOMMENDATION_KEYS: Final[tuple[WeatherRecommendationKey, ...]] = cast(
  tuple[WeatherRecommendationKey, ...],
  get_args(WeatherRecommendationKey),
)
