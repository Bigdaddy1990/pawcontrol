...
class BatchManager:
    ...
    async def should_batch_now(self, force_interval: int = FORCE_BATCH_INTERVAL) -> bool:
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "pending_breakdown": dict(self._pending_updates) if self._pending_updates else {},
        }
    ...
    async def get_next_batch_time(self) -> datetime:
        ...
        async with self._update_lock:
            ...
            return self._last_batch_time + dt_util.dt.timedelta(seconds=FORCE_BATCH_INTERVAL)
