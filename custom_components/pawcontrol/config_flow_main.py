...
class PawControlConfigFlow(
  ...
  async def async_step_user(  # noqa: E111
    ...
    async with timed_operation("user_step"):
      ...
      name_validation = await self._async_validate_integration_name(integration_name)  # noqa: E111
      ...
      # Start the dog setup form with a clean payload after the integration  # noqa: E114
      # name is validated. ``async_step_add_dog`` handles ``None`` by showing  # noqa: E114
  ...
  async def _estimate_total_entities_cached(self) -> int:  # noqa: E111
    ...
    for dog in self._dogs:
      ...
      module_flags = {key: bool(value) for key, value in module_flags_mapping.items()}  # noqa: E111
  ...
  def _format_dogs_list_enhanced(self) -> str:  # noqa: E111
    ...
    for i, dog in enumerate(self._dogs, 1):
      ...
      dog_weight_num = float(dog_weight) if isinstance(dog_weight, int | float) else 0  # noqa: E111
    ...
    try:
      for dog in dogs:  # noqa: E111
        ...
        if modules and not self._entity_factory.validate_profile_for_modules(
          ...
          dog_name_raw = dog.get(DOG_NAME_FIELD) or dog.get(DOG_ID_FIELD, "unknown")  # noqa: E111
          dog_name = str(dog_name_raw) if dog_name_raw is not None else "unknown"  # noqa: E111
