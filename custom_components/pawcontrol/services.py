...
def _format_expires_in_hours_error(error: ValidationError) -> str:
  ...
  if constraint == "expires_in_hours_out_of_range":  # noqa: E111
    ...
    if error.min_value is not None:
      return f"{field} must be greater than {_format_numeric_value(error.min_value)}"  # noqa: E111
  ...
  *,
  ...
  if guard_results:  # noqa: E111
    ...
    for reason_key, count in guard_snapshot.reasons.items():
      reason_bucket[reason_key] = int(reason_bucket.get(reason_key, 0) or 0) + count  # noqa: E111
...
async def async_setup_services(hass: HomeAssistant) -> None:
  ...
  async def _async_handle_feeding_request(  # noqa: E111
    ...
    *,
    ...
    try:
      ...
      error_message = f"Failed to add feeding for {dog_id}. Check the logs for details."  # noqa: E111
      _record_service_result(  # noqa: E111
        runtime_data,
        service=service_name,
        status="error",
    ...
    try:
      ...
      if dog_id is not None:  # noqa: E111
        try:
          ...
          raise _service_validation_error(_format_text_validation_error(err)) from err  # noqa: E111
  ...
  async def acknowledge_notification_service(call: ServiceCall) -> None:  # noqa: E111
    ...
    if not acknowledged:
      error_message = f"No PawControl notification with ID {notification_id} exists."  # noqa: E111
      guard_snapshot = tuple(guard_results)  # noqa: E111
      _record_service_result(  # noqa: E111
        runtime_data,
        service=SERVICE_ACKNOWLEDGE_NOTIFICATION,
...
async def async_unload_services(hass: HomeAssistant) -> None:
  ...
  if isinstance(domain_data, dict):  # noqa: E111
    ...
    if callable(listener):
      try:  # noqa: E111
        listener()
      except Exception as err:  # pragma: no cover - defensive cleanup  # noqa: E111
        _LOGGER.debug(
