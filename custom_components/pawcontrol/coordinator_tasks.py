...
def _summarise_resilience(
    ...
    rejection_rate = (
        rejected_call_count / total_attempts if total_attempts > 0 else None
    )
    summary: CoordinatorResilienceSummary = {
        ...
        "open_breaker_ids": open_breaker_ids,
        "half_open_breakers": half_open_breakers,
        "half_open_breaker_ids": half_open_breaker_ids,
        "unknown_breakers": unknown_breakers,
        "unknown_breaker_ids": unknown_breaker_ids,
        "rejection_breaker_count": len(rejection_breakers),
        "rejection_breakers": rejection_breakers,
        "rejection_breaker_ids": rejection_breaker_ids,
