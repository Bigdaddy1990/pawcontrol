        ...
        CONF_DOGS: [
            {
                ...
                "health_config": {
                    "medications": [
                        ...
                        {"name": "Medication B", "dosage": "5ml", "frequency": "weekly"},
                    ],
                    "vaccinations": [
                        {"name": "Rabies", "last_date": "2024-01-15", "next_due": "2025-01-15"},
                        {"name": "DHPP", "last_date": "2024-03-20", "next_due": "2025-03-20"},
                    ],
                },
                "gps_config": {
...
class TestAdvancedConfigurationValidation:
    ...
    async def test_cross_module_dependency_validation(self, advanced_options_flow):
        ...
        advanced_options_flow._current_dog = advanced_options_flow._config_entry.data[CONF_DOGS][0]
        
        # Configure modules with GPS enabled
        result = await advanced_options_flow.async_step_configure_dog_modules(gps_dependent_config)
    ...
    @pytest.mark.asyncio
    async def test_feeding_health_module_interaction_validation(self, advanced_options_flow):
        ...
        result = await advanced_options_flow.async_step_configure_dog_modules(health_feeding_config)
    ...
    @pytest.mark.asyncio
    async def test_entity_profile_performance_consistency_validation(self, advanced_options_flow):
        ...
        result = await advanced_options_flow.async_step_performance_settings(conflicting_settings)
    ...
    @pytest.mark.asyncio
    async def test_gps_accuracy_distance_relationship_validation(self, advanced_options_flow):
        ...
        gps_configs = [
            ...
            {"gps_accuracy_filter": 100, "gps_distance_filter": 50}, # Questionable ratio
    ...
    @pytest.mark.asyncio
    async def test_data_retention_backup_consistency_validation(self, advanced_options_flow):
        ...
        retention_backup_configs = [
            {"data_retention_days": 30, "auto_backup": True},   # Short retention + backup
            {"data_retention_days": 365, "auto_backup": False}, # Long retention - no backup
...
class TestConfigurationMigrationScenarios:
    ...
    async def test_options_schema_evolution(self, advanced_options_flow):
        ...
        result = await advanced_options_flow.async_step_performance_settings(new_settings)
    ...
    async def test_dog_module_configuration_evolution(self, advanced_options_flow):
        ...
        result = await advanced_options_flow.async_step_configure_dog_modules(new_modules)
...
class TestComplexWorkflowScenarios:
    ...
    async def test_complete_dog_setup_workflow(self, advanced_options_flow):
        ...
        result3 = await advanced_options_flow.async_step_configure_dog_modules(module_config)
    ...
    async def test_multi_dog_configuration_workflow(self, advanced_options_flow):
        ...
        for dog_config in dogs_configs:
            ...
            await advanced_options_flow.async_step_configure_dog_modules(dog_config["modules"])
    ...
    async def test_performance_tuning_workflow(self, advanced_options_flow):
        ...
        result = await advanced_options_flow.async_step_performance_settings(performance_config)
        assert result["type"] == FlowResultType.CREATE_ENTRY
...
class TestAdvancedErrorRecoveryScenarios:
    ...
    async def test_partial_configuration_failure_recovery(self, advanced_options_flow):
        ...
        original_dogs = copy.deepcopy(advanced_options_flow._config_entry.data[CONF_DOGS])
        ...
        advanced_options_flow.hass.config_entries.async_update_entry.side_effect = failing_update
        
        # Try to add multiple dogs
        dog1_result = await advanced_options_flow.async_step_add_new_dog({
    ...
    async def test_network_timeout_recovery(self, advanced_options_flow):
        ...
        advanced_options_flow.hass.config_entries.async_update_entry.side_effect = asyncio.TimeoutError()
    ...
    async def test_memory_pressure_handling(self, advanced_options_flow):
        ...
        advanced_options_flow.hass.config_entries.async_update_entry.side_effect = memory_error_update
...
class TestPerformanceValidationScenarios:
    ...
    @pytest.mark.asyncio
    async def test_large_scale_entity_estimation_performance(self, advanced_options_flow):
    ...
    async def test_memory_efficient_dog_management(self, advanced_options_flow):
        ...
        initial_dogs = advanced_options_flow._dogs.copy()
...
class TestConfigurationConsistencyValidation:
    ...
    async def test_entity_profile_module_consistency(self, advanced_options_flow):
        ...
        for profile, modules in profiles_module_tests:
            ...
            result = await advanced_options_flow.async_step_configure_dog_modules(modules)
    ...
    async def test_performance_settings_consistency(self, advanced_options_flow):
        ...
        for settings in performance_combinations:
            result = await advanced_options_flow.async_step_performance_settings(settings)
    ...
    async def test_notification_feeding_consistency(self, advanced_options_flow):
        ...
        result = await advanced_options_flow.async_step_notifications(notification_config)
