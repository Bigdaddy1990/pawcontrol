...
DEFAULT_SW_VERSION: Final[str] = "1.0.0"
...
CONF_ROUTE_HISTORY_DAYS: Final[str] = "route_history_days"
CONF_AUTO_TRACK_WALKS: Final[str] = "auto_track_walks"
...
CONF_ADVANCED_SETTINGS: Final[str] = "advanced_settings"
CONF_LAST_RECONFIGURE: Final[str] = "last_reconfigure"
CONF_RECONFIGURE_TELEMETRY: Final[str] = "reconfigure_telemetry"
...
DEFAULT_RESILIENCE_SKIP_THRESHOLD: Final[int] = 3
DEFAULT_RESILIENCE_BREAKER_THRESHOLD: Final[int] = 1
...
SERVICE_SEND_NOTIFICATION: Final[str] = "send_notification"
...
MAX_DOG_NAME_LENGTH: Final[int] = 50
