...
class PawControlDashboardGenerator:
  ...
  def _ensure_modules_config(  # noqa: E111
    ...
    modules_payload = dog.get(DOG_MODULES_FIELD) if isinstance(dog, Mapping) else None
    ...
    async with self._operation_semaphore:
      try:  # noqa: E111
        ...
        if dashboard_type == "main":
          ...
          service_execution_metrics = self._resolve_service_execution_metrics()  # noqa: E111
        ...
        async with self._lock:
          ...
          dashboard_info["has_notifications_view"] = self._has_notifications_view(  # noqa: E111
            view_summaries
          )
  ...
  async def _save_dashboard_metadata_async(self) -> None:  # noqa: E111
    ...
    try:
      ...
      # Don't raise - metadata save failure shouldn't break dashboard creation  # noqa: E114
  ...
  def get_dashboard_info(self, dashboard_url: str) -> DashboardMetadata | None:  # noqa: E111
    ...
    if info:
      ...
      typed_info["performance_metrics"] = self._get_dashboard_performance_metrics()  # noqa: E111
  ...
  def get_all_dashboards(self) -> DashboardRegistry[DashboardMetadata]:  # noqa: E111
    ...
    dashboards: DashboardRegistry[DashboardMetadata] = {
      url: cast(DashboardMetadata, dict(info)) for url, info in self._dashboards.items()
    }
  ...
  async def async_create_weather_dashboard(  # noqa: E111
    ...
    breed = (
      str(breed_value) if isinstance(breed_value, str) and breed_value else "Mixed"
    )
    ...
    async with self._operation_semaphore:
      try:  # noqa: E111
        ...
        theme = (
          str(theme_value) if isinstance(theme_value, str) and theme_value else "modern"
        )
