...
class DashboardGenerator:
    ...
    def _generate_quick_actions_card(self, dog_id: str, dog_name: str, modules: Dict) -> Dict[str, Any]:
        ...
        return {
            "type": "horizontal-stack",
            "cards": cards
        } if cards else {"type": "markdown", "content": ""}
    ...
    def _generate_meal_card(self, dog_id: str, meal_type: str, icon: str) -> Dict[str, Any]:
