...
class PawControlCaloriesBurnedTodaySensor(PawControlSensorBase):
  ...
  def extra_state_attributes(self) -> JSONMutableMapping:  # noqa: E111
    ...
    with contextlib.suppress(TypeError, ValueError):
      walk_minutes = float(walk_data["total_duration_today"]) if walk_data else 0.0  # noqa: E111
      walk_distance = float(walk_data["total_distance_today"]) if walk_data else 0.0  # noqa: E111
