...
class WalkDistanceCurrentSensor(BaseDogSensor):
    def __init__(self, hass, dog_id, title):
        super().__init__(hass, dog_id, title, "walk_distance_current")
...
class WalkDistanceLastSensor(BaseDogSensor):
    def __init__(self, hass, dog_id, title):
        super().__init__(hass, dog_id, title, "walk_distance_last")
...
class WalkDurationLastSensor(BaseDogSensor):
    def __init__(self, hass, dog_id, title):
        super().__init__(hass, dog_id, title, "walk_duration_last")
...
class WalkAvgSpeedLastSensor(BaseDogSensor):
    def __init__(self, hass, dog_id, title):
        super().__init__(hass, dog_id, title, "walk_avg_speed_last")
...
class WalkDistanceTodaySensor(BaseDogSensor):
    def __init__(self, hass, dog_id, title):
        super().__init__(hass, dog_id, title, "walk_distance_today")
...
class WalkTimeTodaySensor(BaseDogSensor):
    def __init__(self, hass, dog_id, title):
        super().__init__(hass, dog_id, title, "walk_time_today")
...
class GPSPointsTotalSensor(BaseDogSensor):
    ...
    def __init__(self, hass, dog_id, title):
        super().__init__(hass, dog_id, title, "gps_points_total")
...
class GPSPointsDroppedSensor(BaseDogSensor):
    ...
    def __init__(self, hass, dog_id, title):
        super().__init__(hass, dog_id, title, "gps_points_dropped")
...
class GPSAccuracyAvgSensor(BaseDogSensor):
    ...
    def __init__(self, hass, dog_id, title):
        super().__init__(hass, dog_id, title, "gps_accuracy_avg")
...
class TimeInSafeZoneTodaySensor(BaseDogSensor):
    ...
    def __init__(self, hass, dog_id, title):
        super().__init__(hass, dog_id, title, "time_in_safe_zone_today")
    ...
    def native_value(self):
        st = self.hass.states.get(
            f"sensor.{DOMAIN}_{self._dog}_time_in_safe_zone_today"
        )
        try:
            return (
                int(float(st.state))
...
class SafeZoneEntersTodaySensor(BaseDogSensor):
    ...
    def __init__(self, hass, dog_id, title):
        super().__init__(hass, dog_id, title, "safe_zone_enters_today")
...
class SafeZoneLeavesTodaySensor(BaseDogSensor):
    ...
    def __init__(self, hass, dog_id, title):
        super().__init__(hass, dog_id, title, "safe_zone_leaves_today")
