...
class PawControlOptionsFlowHandler(config_entries.OptionsFlow):
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(
                        ...
                        default=self._options.get(
                            "min_walk_distance_m", DEFAULT_MIN_WALK_DISTANCE_M
                        ),
                    ): NumberSelector(
                        NumberSelectorConfig(
                            min=50,
                    ...
                    vol.Optional(
                        ...
                        default=self._options.get(
                            "min_walk_duration_min", DEFAULT_MIN_WALK_DURATION_MIN
                        ),
                    ): NumberSelector(
                        NumberSelectorConfig(
                            min=1,
    ...
    async def async_step_notifications(
        ...
        if not notify_services:
            notify_services = [
                {"value": DEFAULT_NOTIFICATION_SERVICE, "label": "notify"}
            ]
            ...
            data_schema=vol.Schema(
                {
                    ...
                    vol.Optional(
                        ...
                        default=current_notifications.get(
                            CONF_NOTIFY_FALLBACK, DEFAULT_NOTIFICATION_SERVICE
                        ),
                    ): SelectSelector(
                        SelectSelectorConfig(
