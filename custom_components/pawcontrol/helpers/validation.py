...
def validate_dog_weight(weight: Any) -> float:
    ...
    try:
        ...
        raise ValidationError("Weight must be a number")  # noqa: B904
...
def validate_dog_age(age: Any) -> int:
    ...
    try:
        ...
        raise ValidationError("Age must be a whole number")  # noqa: B904
...
def validate_gps_coordinates(lat: Any, lon: Any) -> tuple[float, float]:
    ...
    try:
        ...
        raise ValidationError("GPS coordinates must be numbers")  # noqa: B904
...
def validate_gps_accuracy(accuracy: Any) -> float | None:
    ...
    try:
        ...
        raise ValidationError("Accuracy must be a number")  # noqa: B904
...
def validate_walk_duration(duration: Any) -> float:
    ...
    try:
        ...
        raise ValidationError("Duration must be a number")  # noqa: B904
...
def validate_distance(distance: Any) -> float:
    ...
    try:
        ...
        raise ValidationError("Distance must be a number")  # noqa: B904
...
def validate_portion_size(portion: Any) -> int:
    ...
    try:
        ...
        raise ValidationError("Portion must be a whole number")  # noqa: B904
...
def validate_medication_slot(slot: Any) -> int:
    ...
    try:
        ...
        raise ValidationError("Slot must be a number")  # noqa: B904
...
def validate_rating(rating: Any) -> int:
    ...
    try:
        ...
        raise ValidationError("Rating must be a whole number")  # noqa: B904
