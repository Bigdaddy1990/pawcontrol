...
class NotificationManager:
    ...
    def _setup_default_handlers(self) -> None:
        ...
        self._handlers[NotificationChannel.PERSISTENT] = (
            self._send_persistent_notification
        )
        ...
        self._handlers[NotificationChannel.MEDIA_PLAYER] = (
            self._send_media_player_notification
        )
    ...
    def _is_quiet_time(
        self, config: NotificationConfig, priority: NotificationPriority
    ) -> bool:
    ...
    async def _send_mobile_notification(self, notification: NotificationEvent) -> None:
        ...
        mobile_service = config.custom_settings.get(
            "mobile_service", "notify.mobile_app"
        )
    ...
    async def _send_tts_notification(self, notification: NotificationEvent) -> None:
        ...
        await self._hass.services.async_call(
            ...
            {
                "message": tts_message,
                "entity_id": config.custom_settings.get(
    ...
    async def async_snooze_notification(
        self, notification_id: str, snooze_duration: timedelta = timedelta(minutes=15)
    ) -> bool:
