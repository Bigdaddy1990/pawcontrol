...
if TYPE_CHECKING:  # pragma: no cover - import heavy HA modules for typing only
    ...
    except ModuleNotFoundError:  # pragma: no cover compatibility shim  # noqa: E111
...
def normalise_json_value(
    ...
    try:  # noqa: E111
        ...
        if isinstance(value, Mapping):
            return {  # noqa: E111
                str(key): normalise_json_value(item, _seen)
...
class PawControlDeviceLinkMixin:
    ...
    # Home Assistant's cooperative multiple inheritance confuses type  # noqa: E114
    # checkers about the precise async_added_to_hass signature,  # noqa: E114
    # so we silence the override warning here.  # noqa: E114
    async def async_added_to_hass(self) -> None:  # type: ignore[override]  # noqa: E111
...
def convert_units(value: float, from_unit: str, to_unit: str) -> float:
    ...
    distance_conversions = {  # noqa: E111
